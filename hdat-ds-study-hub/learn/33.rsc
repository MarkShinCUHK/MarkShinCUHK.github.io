...
18:["$","li","21",{"data-current":false,"children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/21/","children":["21",". ","시계열 데이터 계약과 window"]}]}]
...
24:["$","li","33",{"data-current":true,"children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/33/","children":["33",". ","Problem형 완전 모의 — 차량 센서 다중출력 예측"]}]}]
...
<li>원시 시간의 70%·85%에 경계를 두고, 이전 구간 label이 다음 구간의 예측 원점 전에 알려지도록 horizon만큼 경계 sample을 제외한다. 최종 sample 비율은 정확한 70/15/15가 아니다.</li>
...
2b:["$","$L30",null,{"track":"learn","lesson":"33","goal":"$undefined"}]
2c:["$","section",null,{"className":"lesson-finish","aria-labelledby":"finish-title","children":[["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"LESSON COMPLETE"}],["$","h2",null,{"id":"finish-title","children":"직접 설명하고 실행했다면 완료하세요"}],["$","p",null,{"children":"스크롤만 끝낸 것은 완료가 아닙니다. 이 강의의 완료 기준을 실제로 확인한 뒤 표시하세요."}]]}],["$","$L31",null,{"lessonId":"33"}]]}]
2d:["$","nav",null,{"className":"lesson-pager","aria-label":"이전 및 다음 강의","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/32/","children":[["$","span",null,{"children":"이전 강의"}],["$","strong",null,{"children":["← ",32,". ","Process형 모의고사 — 독자 문제 8문항"]}]]}],["$","a",null,{"className":"next","href":"/hdat-ds-study-hub/learn/34/","children":[["$","span",null,{"children":"다음 강의"}],["$","strong",null,{"children":[34,". ","21일 완주 계획·최종 암기표·합격 체크"," →"]}]]}]]}]
