...
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-07-1">복사</button></div><pre id="code-07-1" tabindex="0" aria-label="7강 Python 코드 1"><code class="language-python">summary = train[num_cols].describe(
...
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-07-2">복사</button></div><pre id="code-07-2" tabindex="0" aria-label="7강 Python 코드 2"><code class="language-python">for c in cat_cols:
...
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-07-3">복사</button></div><pre id="code-07-3" tabindex="0" aria-label="7강 Python 코드 3"><code class="language-python">print(train[TARGET].value_counts(dropna=False, normalize=True))
...
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-07-4">복사</button></div><pre id="code-07-4" tabindex="0" aria-label="7강 Python 코드 4"><code class="language-python">group_stats = train.groupby("vehicle_id", observed=True).agg(
    n=(TARGET, "size"),
...
15:["$","section",null,{"className":"lesson-finish","aria-labelledby":"finish-title","children":[["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"LESSON COMPLETE"}],["$","h2",null,{"id":"finish-title","children":"직접 설명하고 실행했다면 완료하세요"}],["$","p",null,{"children":"스크롤만 끝낸 것은 완료가 아닙니다. 이 강의의 완료 기준을 실제로 확인한 뒤 표시하세요."}]]}],["$","$L17",null,{"lessonId":"07"}]]}]
16:["$","nav",null,{"className":"lesson-pager","aria-label":"이전 및 다음 강의","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/06/","children":[["$","span",null,{"children":"이전 강의"}],["$","strong",null,{"children":["← ",6,". ","확률·통계·정보이론"]}]]}],["$","a",null,{"className":"next","href":"/hdat-ds-study-hub/learn/08/","children":[["$","span",null,{"children":"다음 강의"}],["$","strong",null,{"children":[8,". ","전처리: 결측·이상치·스케일·인코딩·증강"," →"]}]]}]]}]
