...
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-17-1">복사</button></div><pre id="code-17-1" tabindex="0" aria-label="17강 Python 코드 1"><code class="language-python">class MLP(nn.Module):
...
15:["$","section",null,{"className":"lesson-finish","aria-labelledby":"finish-title","children":[["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"LESSON COMPLETE"}],["$","h2",null,{"id":"finish-title","children":"직접 설명하고 실행했다면 완료하세요"}],["$","p",null,{"children":"스크롤만 끝낸 것은 완료가 아닙니다. 이 강의의 완료 기준을 실제로 확인한 뒤 표시하세요."}]]}],["$","$L17",null,{"lessonId":"17"}]]}]
16:["$","nav",null,{"className":"lesson-pager","aria-label":"이전 및 다음 강의","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/16/","children":[["$","span",null,{"children":"이전 강의"}],["$","strong",null,{"children":["← ",16,". ","PyTorch 기초: Tensor·autograd·Dataset·DataLoader"]}]]}],["$","a",null,{"className":"next","href":"/hdat-ds-study-hub/learn/18/","children":[["$","span",null,{"children":"다음 강의"}],["$","strong",null,{"children":[18,". ","PyTorch 학습 엔지니어링: optimizer·초기화·BN·Dropout"," →"]}]]}]]}]
