...
e:["$","section","4",{"children":[["$","p",null,{"children":[["$","span",null,{"children":[4,"단계"]}],"실기 문제 완주"]}],["$","ol",null,{"children":[["$","li","26",{"data-progress-lesson":"26","children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/26/","aria-current":"$undefined","children":[["$","span",null,{"children":"26"}],["$","strong",null,{"children":"Process형 완전 공략: 명세를 edge case까지 구현하기"}],["$","i",null,{"aria-hidden":"true","children":"✓"}]]}]}],["$","li","27",{"data-progress-lesson":"27","children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/27/","aria-current":"$undefined","children":[["$","span",null,{"children":"27"}],["$","strong",null,{"children":"Problem형 공통 파이프라인과 표형 문제"}],["$","i",null,{"aria-hidden":"true","children":"✓"}]]}]}],["$","li","28",{"data-progress-lesson":"28","children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/28/","aria-current":"$undefined","children":[["$","span",null,{"children":"28"}],["$","strong",null,{"children":"시계열 Problem 완주"}],["$","i",null,{"aria-hidden":"true","children":"✓"}]]}]}],["$","li","29",{"data-progress-lesson":"29","children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/29/","aria-current":"$undefined","children":[["$","span",null,{"children":"29"}],["$","strong",null,{"children":"이미지·이상탐지 Problem 분기"}],["$","i",null,{"aria-hidden":"true","children":"✓"}]]}]}],["$","li","30",{"data-progress-lesson":"30","children":["$","a",null,{"href":"/hdat-ds-study-hub/learn/30/","aria-current":"page","children":[["$","span",null,{"children":"30"}],["$","strong",null,{"children":"제출·디버깅·170분 운영"}],["$","i",null,{"aria-hidden":"true","children":"✓"}]]}]}]]}]]}]
...
<ol>
<li>제공 변수명·파일명·저장 cell을 임의로 바꾸지 않는다.</li>
<li>코드 수정 후 <code>Ctrl+S</code>로 수동 저장한다.</li>
<li>Process와 Problem을 각각 제출한다.</li>
<li>제출 파일을 먼저 만들고 성능을 개선한다.</li>
<li>test row order를 보존한다.</li>
<li>전체 helper를 통째 import하거나 완성 pipeline을 무수정 복사하지 않고 필요한 블록만 사용한다.</li>
<li>코드 실행과 모델 학습 시간도 170분에 포함되며, 실행 지연만으로 시험시간이 연장되지 않는다는 공식 운영 조건을 전제로 time cap을 둔다.</li>
</ol>
<h3 id="303-prediction">30.3 prediction 계약 검사</h3>
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-30-1">복사</button></div><pre id="code-30-1" tabindex="0" aria-label="30강 Python 코드 1"><code class="language-python">def validate_prediction(pred, expected_shape, name="prediction"):
    arr = np.asarray(pred)
...
<p>문제에서 dtype을 지정했을 때만 변환한다. float32 변환 후 overflow가 생길 수 있어 다시 검사한다.</p>
<h3 id="304-npy">30.4 NPY</h3>
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-30-2">복사</button></div><pre id="code-30-2" tabindex="0" aria-label="30강 Python 코드 2"><code class="language-python">pred = validate_prediction(pred, (len(test), OUT_DIM))
...
<p><code>(N,)</code>이 요구되는데 <code>(N,1)</code>로 저장하거나 그 반대는 채점 실패가 될 수 있다. 공식 shape를 그대로 쓴다.</p>
<h3 id="305-csv">30.5 CSV</h3>
<p>sample submission이 있으면 복사하고 target 열만 채운다.</p>
<div class="code-shell"><div class="code-toolbar"><span>PYTHON</span><button type="button" data-copy-target="code-30-3">복사</button></div><pre id="code-30-3" tabindex="0" aria-label="30강 Python 코드 3"><code class="language-python">submission = sample_submission.copy()
...
<ol>
<li>model 직전 input shape</li>
<li>flatten/permute 축</li>
<li>Linear input_dim</li>
</ol>
<p><code>Expected target Long</code>:</p>
<ul>
<li>CE target을 <code>.long()</code>, shape <code>[B]</code></li>
</ul>
<p><code>Target size must be same as input</code>:</p>
<ul>
<li>BCE/MSE prediction-target shape를 정확히 맞춤</li>
</ul>
<p><code>CUDA out of memory</code>:</p>
<ul>
<li>batch↓, lazy Dataset, model↓, 불필요 tensor 참조, CPU baseline</li>
</ul>
<p><code>loss NaN</code>:</p>
<ul>
<li>입력/target finite, LR↓, log domain, scaling, gradient 확인</li>
</ul>
<p><code>AUC only one class</code>:</p>
<ul>
<li>split class 확인, stratify/group seed 조정. metric을 임의 변경하지 않음</li>
</ul>
<h3 id="307">30.7 시간 부족 축소 순서</h3>
<ol>
<li>탐색 중지</li>
<li>best checkpoint/첫 제출 보존</li>
<li>epoch/patience 축소</li>
<li>모델 하나만 선택</li>
<li>batch·hidden 축소</li>
<li>CV→holdout</li>
<li>augmentation/복잡 feature 제거</li>
...
<li class="check-item"><label><input type="checkbox" data-check-id="30-4"><span>shape/dtype/NaN/Inf/reload</span></label></li>
<li class="check-item"><label><input type="checkbox" data-check-id="30-5"><span>test 순서와 class mapping</span></label></li>
<li class="check-item"><label><input type="checkbox" data-check-id="30-6"><span>제공 저장 cell 마지막 실행</span></label></li>
<li class="check-item"><label><input type="checkbox" data-check-id="30-7"><span>Ctrl+S</span></label></li>
<li class="check-item"><label><input type="checkbox" data-check-id="30-8"><span>오류·autosave/kernel 문제는 감독관에게 즉시 알림</span></label></li>
</ul>
<h3 id="309">30.9 실습문제</h3>
<ol>
<li>prediction <code>(200,2)</code>를 단일 target CSV 400행에 flatten해 넣으면 왜 위험한가?</li>
<li><code>np.isfinite</code>를 float32 변환 전후 모두 보는 이유는?</li>
<li>CSV 문자열 빈 label이 reload 후 무엇이 될 수 있는가?</li>
<li>성능 개선보다 마지막 7분 제출 검증이 중요한 이유는?</li>
<li>kernel 재시작 전에 해야 할 일은?</li>
</ol>
<details class="answer-panel" id="_31"><summary>정답·해설 보기</summary><div class="answer-body"><ol>
<li>우연히 원소 수가 같아도 sample-target 구조를 파괴한 잘못된 제출이다. 허용 shape를 먼저 제한한다.</li>
<li>매우 큰 float64가 float32에서 Inf로 overflow될 수 있다.</li>
<li>pandas가 NaN으로 읽을 수 있으므로 모든 target 열 결측을 검사한다.</li>
<li>파일 계약 실패는 모델 성능과 무관하게 채점 불가/큰 감점으로 이어질 수 있다.</li>
<li>Ctrl+S로 코드 저장하고 공식 절차·감독관 안내를 따른다.</li>
</ol></div></details>

<h3 id="3010">30.10 완료 기준</h3>
<ul>
<li class="check-item"><label><input type="checkbox" data-check-id="30-9"><span>NPY/CSV를 저장 후 reload한다.</span></label></li>
...
10:["$","main",null,{"className":"lesson-main","id":"main-content","children":["$","article",null,{"children":[["$","header",null,{"className":"lesson-header","children":[["$","nav",null,{"className":"breadcrumbs","aria-label":"현재 위치","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/","children":"34강"}],["$","span",null,{"children":"/"}],["$","span",null,{"children":[4,"단계"]}]]}],["$","p",null,{"className":"lesson-phase","children":[4,"단계 · ","실기 문제 완주"]}],["$","h1",null,{"children":[["$","span",null,{"children":["30","강"]}],"제출·디버깅·170분 운영"]}],["$","p",null,{"className":"lesson-summary","children":"예측 shape·dtype·파일 schema를 검사하고 오류와 시간 부족에 대응하는 마지막 실행 순서를 정리합니다."}],["$","div",null,{"className":"lesson-meta","children":[["$","span",null,{"children":["약 ",55,"분"]}],["$","span",null,{"children":["코드 ",3,"개"]}],["$","span",null,{"children":["표 ",0,"개"]}],["$","span",null,{"children":["완료 체크 ",11,"개"]}]]}],["$","div",null,{"className":"tag-row","children":[["$","span","제출",{"children":"제출"}],["$","span","디버깅",{"children":"디버깅"}],["$","span","시간관리",{"children":"시간관리"}]]}],["$","p",null,{"className":"prerequisites","children":[["$","strong",null,{"children":"먼저 보면 좋은 강의"}],[["$","a","26",{"href":"/hdat-ds-study-hub/learn/26/","children":[26,"강"]}],["$","a","27",{"href":"/hdat-ds-study-hub/learn/27/","children":[27,"강"]}],["$","a","28",{"href":"/hdat-ds-study-hub/learn/28/","children":[28,"강"]}],["$","a","29",{"href":"/hdat-ds-study-hub/learn/29/","children":[29,"강"]}]]]}]]}],["$","details",null,{"className":"mobile-lesson-toc","children":[["$","summary",null,{"children":["이번 강의 목차 ",["$","span",null,{"children":[9,"개"]}]]}],["$","ol",null,{"children":[["$","li","302",{"children":["$","a",null,{"href":"#302","children":"절대 규칙"}]}],["$","li","303-prediction",{"children":["$","a",null,{"href":"#303-prediction","children":"prediction 계약 검사"}]}],["$","li","304-npy",{"children":["$","a",null,{"href":"#304-npy","children":"NPY"}]}],["$","li","305-csv",{"children":["$","a",null,{"href":"#305-csv","children":"CSV"}]}],["$","li","306",{"children":["$","a",null,{"href":"#306","children":"오류 진단 순서"}]}],["$","li","307",{"children":["$","a",null,{"href":"#307","children":"시간 부족 축소 순서"}]}],["$","li","308-30",{"children":["$","a",null,{"href":"#308-30","children":"최종 30초 체크"}]}],["$","li","309",{"children":["$","a",null,{"href":"#309","children":"실습문제"}]}],["$","li","3010",{"children":["$","a",null,{"href":"#3010","children":"완료 기준"}]}]]}]]}],["$","section",null,{"className":"outcome-card","aria-labelledby":"outcome-title","children":[["$","p",null,{"className":"micro-label","children":"AFTER THIS LESSON"}],["$","h2",null,{"id":"outcome-title","children":"이번 강의가 끝나면"}],["$","ul",null,{"children":[["$","li","제공 skeleton과 저장 cell을 보존한다.",{"children":[["$","span",null,{"aria-hidden":"true","children":"✓"}],"제공 skeleton과 저장 cell을 보존한다."]}],["$","li","prediction의 shape, dtype, finite, 순서를 검사한다.",{"children":[["$","span",null,{"aria-hidden":"true","children":"✓"}],"prediction의 shape, dtype, finite, 순서를 검사한다."]}],["$","li","NPY/CSV를 다시 읽어 검증한다.",{"children":[["$","span",null,{"aria-hidden":"true","children":"✓"}],"NPY/CSV를 다시 읽어 검증한다."]}],["$","li","OOM, NaN, shape 오류를 우선순위대로 해결한다.",{"children":[["$","span",null,{"aria-hidden":"true","children":"✓"}],"OOM, NaN, shape 오류를 우선순위대로 해결한다."]}]]}]]}],["$","aside",null,{"className":"recall-note","children":[["$","strong",null,{"children":"처음 공부한다면"}],["$","p",null,{"children":"코드를 읽기 전에 입력과 출력 shape를 종이에 적고, 확인문제는 해설을 열기 전 30초 동안 먼저 설명해 보세요."}]]}],["$","section",null,{"aria-labelledby":"lesson-body-title","children":[["$","h2",null,{"id":"lesson-body-title","className":"sr-only","children":"강의 내용"}],["$","div",null,{"className":"lesson-content","dangerouslySetInnerHTML":{"__html":"$13"}}]]}],"$L14","$L15","$L16"]}]}]
11:["$","aside",null,{"className":"lesson-toc","aria-label":"이번 강의 목차","children":["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"IN THIS LESSON"}],["$","ol",null,{"children":[["$","li","302",{"children":["$","a",null,{"href":"#302","children":"절대 규칙"}]}],["$","li","303-prediction",{"children":["$","a",null,{"href":"#303-prediction","children":"prediction 계약 검사"}]}],["$","li","304-npy",{"children":["$","a",null,{"href":"#304-npy","children":"NPY"}]}],["$","li","305-csv",{"children":["$","a",null,{"href":"#305-csv","children":"CSV"}]}],["$","li","306",{"children":["$","a",null,{"href":"#306","children":"오류 진단 순서"}]}],["$","li","307",{"children":["$","a",null,{"href":"#307","children":"시간 부족 축소 순서"}]}],["$","li","308-30",{"children":["$","a",null,{"href":"#308-30","children":"최종 30초 체크"}]}],["$","li","309",{"children":["$","a",null,{"href":"#309","children":"실습문제"}]}],["$","li","3010",{"children":["$","a",null,{"href":"#3010","children":"완료 기준"}]}]]}]]}]}]
...
15:["$","section",null,{"className":"lesson-finish","aria-labelledby":"finish-title","children":[["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"LESSON COMPLETE"}],["$","h2",null,{"id":"finish-title","children":"직접 설명하고 실행했다면 완료하세요"}],["$","p",null,{"children":"스크롤만 끝낸 것은 완료가 아닙니다. 이 강의의 완료 기준을 실제로 확인한 뒤 표시하세요."}]]}],["$","$L17",null,{"lessonId":"30"}]]}]
16:["$","nav",null,{"className":"lesson-pager","aria-label":"이전 및 다음 강의","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/29/","children":[["$","span",null,{"children":"이전 강의"}],["$","strong",null,{"children":["← ",29,". ","이미지·이상탐지 Problem 분기"]}]]}],["$","a",null,{"className":"next","href":"/hdat-ds-study-hub/learn/31/","children":[["$","span",null,{"children":"다음 강의"}],["$","strong",null,{"children":[31,". ","필기 모의고사 1회 — 20문항 50분"," →"]}]]}]]}]
