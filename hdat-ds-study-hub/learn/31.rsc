...
33:I["66e71be26559",[],"default",1]
3a:I["237608576d2b",[],"default",1]
3b:I["f0433735e848",[],"default",1]
18:["$","a",null,{"href":"/hdat-ds-study-hub/learn/22/","children":["22",". ","RNN·LSTM·GRU와 1D CNN"]}]
...
<p>이 강의의 모의고사는 회차별 20문항으로 구성한 자체 제작 연습이다. 여기의 풀이법과 아래 추가 예제는 공식 문항의 복원이나 출제 예측이 아니다. 50분은 해당 모의의 타이머 설정이며 실제 시험은 최신 회차 안내를 확인한다. 첫 회독이라면 먼저 무제한으로 풀이 근거를 써도 좋다. 이후 같은 답을 외워 재응시한 점수를 새로운 문제에 대한 실력으로 해석하지 않도록 숫자·축·조건을 바꾼 변형으로 점검한다.</p>
<h4 id="topic-31-2">답을 고르기 전에 문제를 한 문장으로 다시 말하기</h4>
<p>‘정답이 하나인 3클래스 분류’를 ‘사진마다 세 이름 중 딱 하나를 고르는 문제’로 바꾸어 읽어 보자. 이제 출력 세 칸은 세 물리량이 아니라 세 이름의 점수다. 여기서 ‘하나’를 놓치면 서로 독립인 여러 라벨 문제를 골라도 배열 크기가 비슷해 보인다. 객관식은 용어의 친숙함보다 어떤 조건이 선택지들을 가르는지 알아내는 과제다.</p>
<p>이 강의의 짧은 세 예제는 전 범위 이론을 대체하지 않는다. 원 교재 1·2·3회에는 전처리·고전모델·미분·CNN·시계열·생성모델이 함께 나온다. 모르는 용어가 있다면 해당 강의의 작은 예로 돌아간 뒤 여기서 조건을 읽는 방법을 적용한다. 이미 본 정답 번호를 빠르게 떠올리는 속도와 새 조건에서 식을 만드는 능력은 따로 기록해야 한다.</p>
<h3 id="visual-31-2">낯선 말부터 풀기</h3>
<h4 id="topic-31-3">소거는 ‘틀려 보인다’가 아니라 실패한 조건을 찾는 일이다</h4>
<p>선택지 ③이 서로 독립적인 세 이진 라벨이라면 한 사진에 [1,1,0]도 허용한다. 하지만 단일정답 문제에서 앞 두 클래스가 동시에 정답인 것은 조건과 맞지 않는다. 이 한 입력이 구체적인 반례다. 반대로 정답 두 개를 허용하는 문제라면 그 선택지는 잘못이 아닐 수 있다. 오답 선택지의 문장 전체를 항상 틀린 규칙으로 외우지 않는 이유다.</p>
<p>조건어 ‘훈련에서만’은 정보 사용 범위를, ‘같은 크기’는 축의 대응을, ‘초과’는 경계 포함 여부를 정한다. 점수 0.3과 임계값 0.3에서 &gt;는 거짓, ≥는 참이다. 두 규칙의 차이는 값이 큰 대부분의 예시에서 드러나지 않지만 경계 한 개에서 정답을 바꾼다. 확신도는 이 조건들을 실제로 확인했는지와 함께 적어야 복습에 쓸 수 있다.</p>
<h4 id="topic-31-4">조건과 반례</h4>
<p>조건어는 “항상”, “훈련 시”, “검증에서”, “서로 배타적”처럼 명제의 범위를 정하는 말이다. 반례는 그 명제를 깨뜨리는 한 가지 예다. “더 깊은 모델은 항상 검증 성능이 좋다”는 과적합 사례 하나만 있어도 일반 명제로는 틀리다. 그러나 “항상이라는 말이 있으면 모두 오답”으로 암기해서는 안 된다. 배열 크기를 지정하는 명세처럼 반드시 지켜야 하는 조건도 있기 때문이다.</p>
...
<h3 id="visual-31-3">그림을 읽는 순서</h3><p>먼저 축·색·연결 방향을 읽고, 각 그림 아래의 설명으로 확인하세요. 이어지는 손계산은 같은 개념을 다른 작은 숫자로 연습할 수도 있습니다.</p><figure class="course-figure" id="figure-31-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 244" role="img" aria-labelledby="figure-31-1-title figure-31-1-desc"><title id="figure-31-1-title">필기 선택지를 조건·식·반례로 확인</title><desc id="figure-31-1-desc">문제가 묻는 것이 정의·계산·비교 중 무엇인지 확인한다. 조건과 분모·축을 표시하고 작은 숫자나 반례를 대입한 뒤, 정답과 오답의 이유를 설명한다.</desc><rect width="360" height="244" fill="#fff"></rect><g fill="#13203a" font-family="Arial, Apple SD Gothic Neo, Malgun Gothic, sans-serif"><rect x="28" y="14" width="304" height="39" rx="5" fill="#eaf3ff" stroke="#1768df"></rect><text x="180" y="39" text-anchor="middle" font-size="16"><tspan x="180" dy="0">무엇을 묻나? 정의 / 계산 / 비교</tspan></text><rect x="28" y="70" width="304" height="39" rx="5" fill="#eaf3ff" stroke="#1768df"></rect><text x="180" y="95" text-anchor="middle" font-size="16"><tspan x="180" dy="0">문제의 조건·분모·축 표시</tspan></text><line x1="180" y1="53" x2="180" y2="68" stroke="#64748b" stroke-width="2"></line><path d="M176.64402122977057,61.85692206676739 L180,68 L183.35597877022943,61.85692206676739" fill="none" stroke="#64748b" stroke-width="3"></path><rect x="28" y="126" width="304" height="39" rx="5" fill="#eaf3ff" stroke="#1768df"></rect><text x="180" y="151" text-anchor="middle" font-size="16"><tspan x="180" dy="0">작은 숫자 또는 반례 대입</tspan></text><line x1="180" y1="109" x2="180" y2="124" stroke="#64748b" stroke-width="2"></line><path d="M176.64402122977057,117.8569220667674 L180,124 L183.35597877022943,117.8569220667674" fill="none" stroke="#64748b" stroke-width="3"></path><rect x="28" y="182" width="304" height="39" rx="5" fill="#e6f7f1" stroke="#168765"></rect><text x="180" y="207" text-anchor="middle" font-size="16"><tspan x="180" dy="0">맞는 이유와 다른 선택지 오류 설명</tspan></text><line x1="180" y1="165" x2="180" y2="180" stroke="#64748b" stroke-width="2"></line><path d="M176.64402122977057,173.8569220667674 L180,180 L183.35597877022943,173.8569220667674" fill="none" stroke="#64748b" stroke-width="3"></path></g></svg><figcaption><strong>그림 31-1. 필기 선택지를 조건·식·반례로 확인</strong>정답 번호 암기 대신 같은 개념의 변형 질문을 풀 수 있는지 확인한다. 실제 필기 시간과 문항 수는 회차 공식 안내를 따른다.</figcaption><a class="figure-open" href="/hdat-ds-study-hub/figures/course/31-1.svg" target="_blank" rel="noopener noreferrer">그림 31-1 크게 열기 ↗</a><details class="figure-text"><summary>그림의 값·구조를 글로 읽기</summary><p>문제가 묻는 것이 정의·계산·비교 중 무엇인지 확인한다. 조건과 분모·축을 표시하고 작은 숫자나 반례를 대입한 뒤, 정답과 오답의 이유를 설명한다.</p></details></figure><figure class="course-figure" id="figure-31-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 260" role="img" aria-labelledby="figure-31-2-title figure-31-2-desc"><title id="figure-31-2-title">정확도만 보면 놓치는 소수 클래스</title><desc id="figure-31-2-desc">100개 중 정상은 95개, 불량은 5개다. 모두 정상이라고 예측하면 정확도는 95%지만 불량 재현율은 0%다.</desc><rect width="360" height="260" fill="#fff"></rect><g fill="#13203a" font-family="Arial, Apple SD Gothic Neo, Malgun Gothic, sans-serif"><text x="180" y="48" text-anchor="middle" font-size="16"><tspan x="180" dy="0">예측 불량       예측 정상</tspan></text><rect x="80" y="64" width="102" height="52" rx="5" fill="#f5f7fa" stroke="#c8d2de"></rect><text x="131" y="92" text-anchor="middle" font-size="16"><tspan x="131" dy="0">0</tspan></text><rect x="185" y="64" width="102" height="52" rx="5" fill="#f5f7fa" stroke="#c8d2de"></rect><text x="236" y="92" text-anchor="middle" font-size="16"><tspan x="236" dy="0">5</tspan></text><rect x="80" y="119" width="102" height="52" rx="5" fill="#f5f7fa" stroke="#c8d2de"></rect><text x="131" y="147" text-anchor="middle" font-size="16"><tspan x="131" dy="0">0</tspan></text><rect x="185" y="119" width="102" height="52" rx="5" fill="#f5f7fa" stroke="#c8d2de"></rect><text x="236" y="147" text-anchor="middle" font-size="16"><tspan x="236" dy="0">95</tspan></text><text x="40" y="98" text-anchor="middle" font-size="16"><tspan x="40" dy="0">불량</tspan></text><text x="40" y="153" text-anchor="middle" font-size="16"><tspan x="40" dy="0">정상</tspan></text><text x="180" y="220" text-anchor="middle" font-size="16"><tspan x="180" dy="0">Accuracy 95% / 불량 Recall 0%</tspan></text></g></svg><figcaption><strong>그림 31-2. 정확도만 보면 놓치는 소수 클래스</strong>실제 불량이 첫 행이다. precision의 분모인 예측 불량 수가0이므로0분모 정책도 확인한다. 좋은 정확도와 실제 검출 능력을 구분하는 독립 연습 예다.</figcaption><a class="figure-open" href="/hdat-ds-study-hub/figures/course/31-2.svg" target="_blank" rel="noopener noreferrer">그림 31-2 크게 열기 ↗</a><details class="figure-text"><summary>그림의 값·구조를 글로 읽기</summary><p>100개 중 정상은 95개, 불량은 5개다. 모두 정상이라고 예측하면 정확도는 95%지만 불량 재현율은 0%다.</p></details></figure>



<h3 id="visual-31-4">숫자로 끝까지 따라가기</h3>
<h4 id="topic-31-5">수식의 분모가 어떤 집단인지 먼저 표시하기</h4>
<p>이상탐지 경보 일곱 개 중 실제 이상이 네 개면 정밀도의 분모는 일곱이다. 실제 이상 다섯 개 중 네 개를 찾았다면 재현율의 분모는 다섯이다. 둘 다 분자 4가 나와서 비슷해 보이지만 ‘경보한 것 중’과 ‘실제 이상 중’이라는 질문이 다르다. 혼동행렬을 그릴 때 먼저 실제 상태로 정상·이상을 나누고 각 집단에서 어떤 예측을 했는지 세면 분모가 보인다.</p>
<p>CE에서는 한 샘플 안의 클래스 확률을 구하는 합과 여러 샘플의 손실을 평균하는 나눗셈이 따로 있다. 합성곱에서는 커널 면적을 가중치 수에 곱하지만 공간 출력 길이는 필터가 놓일 수 있는 시작점 수다. 그림이나 수식 옆에 ‘무엇을 세는 수인가’를 적으면 익숙한 공식을 엉뚱한 질문에 적용하는 일을 줄일 수 있다.</p>
<h4 id="topic-31-6">같은 TP에서 다른 질문이 나온다</h4>
...
<tr>
<td>F1</td>
<td>정밀도·재현율을 함께 요약</td>
<td>2TP/(2TP+FP+FN)</td>
</tr>
</tbody></table></div>
<h4 id="topic-31-7">분류·지표·CNN 검산</h4>
<p>자체 제작 예제 A: “정답이 하나인 3클래스 분류, 배치 크기 2, 클래스 인덱스 정답”에 알맞은 조합을 고른다. ① 출력 <code>[2,1]</code>, MSE ② 출력 <code>[2,3]</code> 로짓, 정답 <code>[2]</code> long 정수형, CE ③ 출력 <code>[2,3]</code> 시그모이드, 정답 <code>[2,3]</code>의 서로 독립적인 이진 라벨 ④ 출력 <code>[3,2]</code>, 정답 <code>[2]</code>. 정답은 ②다. ①은 회귀 구조이며 ③은 다중 라벨 분류가 되고 ④는 배치와 클래스 축이 뒤집혔다.</p>
<p>이를 숫자로 검산한다. 첫 샘플 로짓 <code>[0,log2,0]</code>, 정답 1이면 정답 확률은 <code>2/(1+2+1)=0.5</code>라 손실 <code>log2≈0.693</code>이다. 둘째 로짓 <code>[0,0,0]</code>, 정답 2이면 확률 1/3, 손실 <code>log3≈1.099</code>다. 가중치 없는 배치 평균 CE는 <code>(log2+log3)/2≈0.896</code>이다. 클래스 수 3으로 마지막에 또 나누지 않는다.</p>
<p>자체 제작 예제 B: 실제 이상 5개 중 4개를 찾고, 정상 95개 중 3개를 이상으로 경보했다. <code>TP=4,FN=1,FP=3,TN=92</code>다. 정밀도는 <code>4/(4+3)=4/7≈0.571</code>, 재현율은 <code>4/(4+1)=0.8</code>, F1은 <code>2TP/(2TP+FP+FN)=8/12≈0.667</code>이다. 정확도는 <code>(4+92)/100=0.96</code>이다. 높은 정확도와 완벽하지 않은 이상 탐지가 동시에 성립한다.</p>
<p>자체 제작 예제 C: 입력 크기 9, 커널 3, 패딩 1, 보폭 2, 팽창률 1인 합성곱의 길이는 <code>floor((9+2-2-1)/2+1)=5</code>다. “보폭 2니까 무조건 절반인 4.5”라는 답은 출력 위치의 개수는 정수로 세어야 한다는 점을 놓친 것이다. 공식 안에서 유효 커널 크기와 패딩을 먼저 계산한다.</p>
<h4 id="topic-31-8">계산 세 개를 중간 결과로 검산하기</h4>
<p>예제 A의 첫 행에서 exp(0)=1, exp(log2)=2, exp(0)=1을 더하면 4다. 정답 위치 1의 확률은 2/4=0.5다. 둘째 행은 모두 exp(0)=1이라 합이 3, 정답 위치 2의 확률은 1/3이다. 두 음의 로그를 더한 값 약 1.791759를 샘플 수 2로 나누어 약 0.895880을 얻는다. 정답이 가리키는 클래스 칸을 고르기 전 세 클래스 손실을 평균하지 않는다. <a href="https://cs231n.github.io/neural-networks-3/" target="_blank" rel="noreferrer noopener">Stanford CS231n 학습 노트</a>의 초기 손실 검산처럼, 세 점수가 같은 모델에서 log3이 나오는지 확인할 수 있다.</p>
<p>예제 B는 실제 이상 5개에서 TP=4를 빼 FN=1, 정상 95개에서 FP=3을 빼 TN=92를 구한다. 합은 4+1+3+92=100이다. F1의 분자는 2×4=8, 분모는 8+3+1=12라 2/3이다. 정확도 96%는 전체 100개 중 맞힌 96개를 뜻하고, 고장 하나를 놓친 사실을 없애지는 않는다.</p>
<p>예제 C는 패딩 후 길이 9+2=11, 유효 커널 폭 3이다. 마지막 커널의 시작은 11−3=8까지 가능하고 보폭 2의 시작점은 0·2·4·6·8 다섯 곳이다. 공식의 floor와 +1이 왜 필요한지 이 목록으로 이해할 수 있다.</p>
...
<p>코드는 문제를 푼 뒤 검산하는 도구다. 이 모의에서는 자료를 보지 않는 연습을 할 때 코드 실행이나 검색도 사용하지 않고, 채점한 뒤 어느 계산이 틀렸는지 확인한다. 이는 자체 연습 방법을 설명한 것이며 실제 시험에서 특정 도구를 사용할 수 있다는 뜻은 아니다.</p>
<blockquote>
<p>핵심 기억: 선택지를 가르는 조건과 수식의 분모를 먼저 정한 뒤 작은 숫자로 검산한다.</p>
</blockquote>
<h3 id="visual-31-5">시험 문제로 연결하기</h3>
<h4 id="topic-31-9">전 범위로 옮기는 풀이법</h4>
<p>모의 50분을 첫 순회 35분, 보류 10분, 답안 점검 5분으로 나누어 보자. 첫 35분에 20문항을 모두 보려면 평균 1분45초다. 전체 평균 <code>50/20=2.5분</code>과 같지 않다. “문제당 2.5분씩 무조건 소비”하면 돌아볼 시간이 남지 않는다. 쉬운 문제에서 아낀 시간을 계산이 긴 문제에 쓸 수 있도록 배분한다.</p>
<p>교재의 다른 필기 주제에도 같은 소거법을 쓴다. 누수는 어떤 자료로 무엇을 언제 학습했는지, 드롭아웃·배치 정규화(BN)는 학습 모드와 평가 모드에서 어떻게 동작하는지, 어텐션(Attention)은 점수 배열의 각 축이 무엇인지, AE/VAE/GAN은 무엇을 생성하고 어떤 손실을 최소화하는지 구체적으로 묻는다. 정답 번호만 외우기보다 틀린 선택지를 올바른 문장으로 고쳐 쓰면 변형 문제에도 대응할 수 있다.</p>
<h4 id="topic-31-10">지표 방향과 학습 종류를 같은 자료에서 비교하기</h4>
<p>점수가 MSE라면 0.8보다 0.5가 좋고, F1이라면 0.8이 더 좋다. 낮은 손실과 높은 F1은 같은 뜻이 아니다. 확률을 얼마나 잘 주는지 보는 손실과 임계값으로 나눈 라벨의 TP·FP·FN을 보는 F1은 정보가 다르기 때문이다. 확률이 조금 달라져도 임계값을 넘지 않으면 라벨과 F1은 그대로일 수 있다.</p>
<p>KNN과 트리의 차이도 작게 시험한다. 훈련값 [0,5,10]을 [0,0.5,1]로 바꾼 후 테스트 15는 1.5다. KNN은 고정된 좌표에서 거리를 구하고, 트리는 x≤5라는 경계를 바뀐 좌표 x′≤0.5로 대응시킬 수 있다. 그래서 단조 척도 변환의 영향이 일반적인 임계값 트리에서 작을 수 있다. 다만 모든 전처리가 단조인 것은 아니고 잘라내기·결측 대체는 정보나 순서를 바꿀 수 있다. 모델 이름 하나로 전처리의 효과를 단정하지 않는다.</p>
<h3 id="visual-31-6">자주 헷갈리는 지점</h3>
<h4 id="topic-31-11">숫자를 해석하는 범위</h4>
<p>정확도 96%를 보고 좋은 모델이라고 단정하거나 낮은 손실을 보고 항상 높은 F1이라고 연결하지 않는다. 각 지표가 평가하는 성능이 다르다. 수식에서 <code>Σ</code>의 축을 생략하고 외우면 배치 평균·클래스 합을 두 번 나누기 쉽다. 자연로그를 쓰는 CE와 밑이 2인 엔트로피 문제는 단위가 달라질 수 있으므로 지시를 확인한다.</p>
...
<h4 id="topic-31-12">같은 평균처럼 보이지만 다른 가중치를 검사하기</h4>
<p>위 CE는 모든 샘플 가중치가 같은 평균이다. 클래스 가중치를 지정한 클래스 인덱스 CE에서 기본 가중 평균은 선택된 정답 클래스 가중치의 합으로 나누므로 단순히 배치 수로 나눈 값과 다를 수 있다. 분모가 무엇인지 명세와 사용 도구의 정의를 확인한다. ‘평균’이라는 단어만 보고 모든 수식의 마지막에 N을 쓰지 않는다.</p>
<p>Macro-F1도 전체 샘플에서 양성 F1 하나를 계산한 것이 아니다. 클래스마다 그 클래스를 양성으로 보는 F1을 구한 뒤 클래스 수로 평균한다. 정상 95개와 이상 5개가 있어도 두 클래스에 같은 비중을 주는 목적이다. 반면 가중 평균은 클래스 표본 수 등을 반영할 수 있다. 오답을 고칠 때 ‘분모 실수’라고만 적지 말고 ‘경보 집단 대신 전체 집단으로 나누었다’처럼 잘못 고른 집단을 기록한다. 다음 문제에서 같은 질문을 반복해 원인을 줄일 수 있다.</p>
<blockquote>
<p>흔한 오해: 항상이라는 단어가 있으면 모두 오답이라는 암기도 조건을 읽지 않는 방식이다.</p>
</blockquote>
<blockquote>
<p>팁: 답을 바꿀 때는 처음 답이 어긴 조건 또는 반례를 한 줄 남긴다.</p>
</blockquote>
...
28:["$","section",null,{"aria-labelledby":"lesson-body-title","children":[["$","h2",null,{"id":"lesson-body-title","className":"sr-only","children":"강의 내용"}],null,["$","section",null,{"className":"visual-lesson","aria-labelledby":"visual-lesson-title","children":[["$","header",null,{"className":"visual-intro","children":[["$","p",null,{"className":"micro-label","children":"그림으로 보고, 계산하고, 설명하기"}],["$","h2",null,{"id":"visual-lesson-title","children":"그림으로 이해하고, 작은 숫자로 확인하기"}],["$","p",null,{"children":"문제 상황에서 시작해, 작은 예제의 계산을 정확한 정의와 코드로 이어 갑니다. 처음 보는 기호는 무엇을 가리키는지 확인하고, 결과가 왜 그렇게 나왔는지 설명해 보세요."}],["$","ol",null,{"className":"visual-route","children":[["$","li",null,{"children":["$","a",null,{"href":"#visual-31-1","children":"1. 상황과 용어"}]}],["$","li",null,{"children":["$","a",null,{"href":"#visual-31-3","children":"2. 개념 그림"}]}],["$","li",null,{"children":["$","a",null,{"href":"#visual-31-4","children":"3. 손계산"}]}],["$","li",null,{"children":["$","a",null,{"href":"#theory-31","children":"4. 필기 이론"}]}]]}]]}],["$","div",null,{"dangerouslySetInnerHTML":{"__html":"$34"}}]]}],"$L35","$L36","$L37","$L38","$L39"]}]
29:["$","section",null,{"className":"lesson-sources","aria-labelledby":"lesson-sources-title","children":[["$","div",null,{"className":"lesson-sources-heading","children":[["$","p",null,{"className":"micro-label","children":"공식 참고 자료"}],["$","h2",null,{"id":"lesson-sources-title","children":"공식 자료로 한 번 더 확인하기"}],["$","p",null,{"children":"본문을 이해한 뒤 필요한 항목만 대조하세요. 외부 링크는 시험 전 학습용입니다."}]]}],["$","div",null,{"className":"source-list","children":[["$","a","https://exam.hyundai-ngv.com/practice/13567",{"href":"https://exam.hyundai-ngv.com/practice/13567","target":"_blank","rel":"noreferrer noopener","children":[["$","span",null,{"children":"HDAT 공식"}],["$","strong",null,{"children":"HDAT-DS 공식 연습문제 안내"}],["$","p",null,{"children":"필기 20문항 50분, 실기 Process 8문항과 Problem 1문항 170분 및 공개 범위를 확인합니다."}],["$","small",null,{"children":"공식 페이지 열기 ↗"}]]}],["$","a","https://ds100.org/course-notes-su23/pandas_3/pandas_3.html",{"href":"https://ds100.org/course-notes-su23/pandas_3/pandas_3.html","target":"_blank","rel":"noreferrer noopener","children":[["$","span",null,{"children":"대학 공개강의"}],["$","strong",null,{"children":"Berkeley Data 100 · 표의 행과 그룹별 집계"}],["$","p",null,{"children":"학부 중급 강의노트입니다. 그룹별 요약과 원래 행에 붙이는 값의 차이, 병합 전후 관측 단위를 설명하는 순서를 참고했습니다."}],["$","small",null,{"children":"공식 페이지 열기 ↗"}]]}],["$","a","https://ds100.org/debugging-guide/jupyter101/",{"href":"https://ds100.org/debugging-guide/jupyter101/","target":"_blank","rel":"noreferrer noopener","children":[["$","span",null,{"children":"대학 공개강의"}],["$","strong",null,{"children":"Berkeley Data 100 · 노트북 실행과 저장"}],["$","p",null,{"children":"학부 과제 입문 안내입니다. 셀의 실행 상태·파일 저장·처음부터 재실행은 서로 다르다는 점을 참고했습니다. 대학의 과제 제출 규칙을 HDAT 규칙으로 적용하지 않습니다."}],["$","small",null,{"children":"공식 페이지 열기 ↗"}]]}]]}],["$","details",null,{"className":"university-reading","children":[["$","summary",null,{"children":["함께 읽을 대학 강의·슬라이드 · ",2,"개"]}],["$","p",null,{"children":"입문·학부 자료를 중심으로 참고하되, 고급 학부나 학부·대학원 합반 자료는 수준을 따로 적었습니다. 원문을 모두 읽어야 이 강의를 풀 수 있다는 뜻은 아닙니다. 대학 자료는 이해를 돕는 참고 문헌이며 HDAT 시험 범위를 정하는 근거는 아닙니다."}],["$","ul",null,{"children":[["$","li","https://ds100.org/course-notes-su23/pandas_3/pandas_3.html",{"children":[["$","a",null,{"href":"https://ds100.org/course-notes-su23/pandas_3/pandas_3.html","target":"_blank","rel":"noreferrer noopener","children":["Berkeley Data 100 · 표의 행과 그룹별 집계"," ↗"]}],["$","p",null,{"children":"학부 중급 강의노트입니다. 그룹별 요약과 원래 행에 붙이는 값의 차이, 병합 전후 관측 단위를 설명하는 순서를 참고했습니다."}]]}],["$","li","https://ds100.org/debugging-guide/jupyter101/",{"children":[["$","a",null,{"href":"https://ds100.org/debugging-guide/jupyter101/","target":"_blank","rel":"noreferrer noopener","children":["Berkeley Data 100 · 노트북 실행과 저장"," ↗"]}],["$","p",null,{"children":"학부 과제 입문 안내입니다. 셀의 실행 상태·파일 저장·처음부터 재실행은 서로 다르다는 점을 참고했습니다. 대학의 과제 제출 규칙을 HDAT 규칙으로 적용하지 않습니다."}]]}]]}]]}]]}]
2a:["$","$L3a",null,{"track":"learn","lesson":"31","goal":"$undefined"}]
2b:["$","section",null,{"className":"lesson-finish","aria-labelledby":"finish-title","children":[["$","div",null,{"children":[["$","p",null,{"className":"micro-label","children":"학습 마무리"}],["$","h2",null,{"id":"finish-title","children":"직접 설명하고 실행했다면 완료하세요"}],["$","p",null,{"children":"끝까지 읽었다면 아래 완료 기준도 확인해 보세요. 직접 설명하거나 실행할 수 있는 항목을 표시하면 됩니다."}]]}],["$","$L3b",null,{"lessonId":"31"}]]}]
2c:["$","nav",null,{"className":"lesson-pager","aria-label":"이전 및 다음 강의","children":[["$","a",null,{"href":"/hdat-ds-study-hub/learn/30/","children":[["$","span",null,{"children":"이전 강의"}],["$","strong",null,{"children":["← ",30,". ","제출·디버깅·170분 운영"]}]]}],["$","a",null,{"className":"next","href":"/hdat-ds-study-hub/learn/32/","children":[["$","span",null,{"children":"다음 강의"}],["$","strong",null,{"children":[32,". ","Process형 모의고사 — 자체 제작 8문항"," →"]}]]}]]}]
2d:["$","li","317-3",{"children":["$","a",null,{"href":"#317-3","children":"필기 모의고사 3회 — 계산·전 범위 혼합"}]}]
2e:["$","p",null,{"className":"toc-group-label","children":"기초 확인과 해설"}]
2f:["$","ol",null,{"children":[["$","li","visual-31-7",{"children":["$","a",null,{"href":"#visual-31-7","children":"스스로 확인하기"}]}],["$","li","visual-31-8",{"children":["$","a",null,{"href":"#visual-31-8","children":"정답과 이유"}]}],["$","li","visual-31-9",{"children":["$","a",null,{"href":"#visual-31-9","children":"더 읽을 공식 자료"}]}]]}]
...
<span id="question-O31-02" data-question-id="O31-02" class="section-anchor"></span><h4 id="2_1">2번. 전처리 누수</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>다음 중 검증자료의 정보가 학습에 유출되지 않는 것은?</p>
<p>① 분할 전에 전체 데이터로 StandardScaler를 학습한다.<br>② 분할 전에 전체 데이터로 PCA를 학습한다.<br>③ 분할 후 훈련 폴드에서 중앙값을 구해 검증자료에 적용한다.<br>④ 분할 전에 전체 데이터에 SMOTE를 적용한 뒤 나눈다.</p>
...
<p>이진분류 노드의 클래스 비율이 0.5/0.5에서 1.0/0.0으로 바뀌면 엔트로피(entropy)는 어떻게 변하는가?</p>
<p>① 0에서 최대로 증가 ② 최대에서 0으로 감소 ③ 변하지 않음 ④ 음수가 됨</p>
<span id="question-O31-04" data-question-id="O31-04" class="section-anchor"></span><h4 id="4-validation">4번. Validation</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>800대 차량에서 차량당 여러 센서 행을 수집했으며, 테스트에는 처음 보는 차량만 등장한다. 가장 적절한 검증 방법은?</p>
<p>① 행 단위 무작위 분할 ② 행 단위 계층화 분할 ③ 차량 단위 그룹 분할 ④ 전체 훈련자료로 학습한 뒤 같은 자료에서 점수 계산</p>
...
<p>고장 클래스가 1%인 이진분류에서 소수 클래스의 성능을 드러내기 위한 첫 지표로 가장 적절한 것은?</p>
<p>① accuracy ② Macro-F1 ③ MSE ④ R²</p>
<span id="question-O31-06" data-question-id="O31-06" class="section-anchor"></span><h4 id="6-loss">6번. 손실함수의 입력 조건</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details>
<p>클래스가 4개이고 정답이 하나인 분류에서 <code>CrossEntropyLoss</code>의 올바른 입력은?</p>
<p>① 시그모이드 확률 <code>(B,1)</code>, 실수형 정답 <code>(B,1)</code><br>② 소프트맥스 확률 <code>(B,4)</code>, 원-핫 정답 <code>(B,4)</code>만 가능<br>③ 변환하지 않은 로짓 <code>(B,4)</code>, long 정수형 클래스 인덱스 <code>(B,)</code><br>④ 변환하지 않은 로짓 <code>(B,)</code>, long 정수형 정답 <code>(B,4)</code></p>
<span id="question-O31-07" data-question-id="O31-07" class="section-anchor"></span><h4 id="7">7번. 역전파</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details>
<p><code>pred=wx</code>, <code>L=(pred-y)²</code>, <code>x=2,w=1,y=5</code>일 때 <code>dL/dw</code>는?</p>
<p>① -12 ② -6 ③ 6 ④ 12</p>
<span id="question-O31-08" data-question-id="O31-08" class="section-anchor"></span><h4 id="8-optimizer">8번. Optimizer</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details>
<p>모멘텀(Momentum)의 핵심 설명으로 가장 적절한 것은?</p>
<p>① 기울기를 항상 0으로 만든다.<br>② 과거 갱신 방향을 누적해 일관된 방향으로는 가속하고 진동은 줄인다.<br>③ 모든 매개변수를 같은 상수로 바꾼다.<br>④ 검증 손실을 직접 미분한다.</p>
<span id="question-O31-09" data-question-id="O31-09" class="section-anchor"></span><h4 id="9-batch-normalization">9번. Batch Normalization</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-7">학습·평가 모드의 차이와 데이터 증강·전이학습</a></p></details>
<p>track_running_stats=True인 BatchNorm을 model.eval()로 평가할 때 옳은 것은?</p>
<p>① 현재 샘플 하나의 통계만 사용한다.<br>② 학습 중 저장한 누적 평균·분산을 사용한다.<br>③ 모든 활성값을 0으로 만든다.<br>④ 드롭아웃 확률을 자동으로 선택한다.</p>
<span id="question-O31-10" data-question-id="O31-10" class="section-anchor"></span><h4 id="10-cnn">10번. CNN 출력 크기</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p>한 공간축의 입력 크기 64, 커널 크기 5, 패딩 2, 보폭(stride) 2, 팽창률(dilation) 1인 합성곱의 출력 크기는?</p>
<p>① 30 ② 31 ③ 32 ④ 64</p>
<span id="question-O31-11" data-question-id="O31-11" class="section-anchor"></span><h4 id="11-cnn-parameter">11번. CNN parameter</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p><code>Conv2d(3, 10, kernel_size=3, bias=True)</code>의 매개변수 수는?</p>
<p>① 270 ② 280 ③ 300 ④ 입력 높이·너비에 따라 다름</p>
<span id="question-O31-12" data-question-id="O31-12" class="section-anchor"></span><h4 id="12-lstm">12번. LSTM</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-9">RNN의 상태와 입력 구간의 시점을 분리하기</a></p></details>
<p>LSTM의 망각 게이트(forget gate)가 하는 주된 역할은?</p>
<p>① 클래스 확률 정규화 ② 이전 셀 상태의 유지 정도 조절 ③ 이미지 다운샘플링 ④ 학습률 감소</p>
<span id="question-O31-13" data-question-id="O31-13" class="section-anchor"></span><h4 id="13-rnn-shape">13번. RNN shape</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-9">RNN의 상태와 입력 구간의 시점을 분리하기</a></p></details>
<p><code>GRU(input_size=6, hidden_size=32, batch_first=True)</code>에 <code>(B=8,T=15,F=6)</code>을 넣은 단방향 1층 시퀀스 출력의 크기는?</p>
<p>① <code>(8,32)</code> ② <code>(15,8,32)</code> ③ <code>(8,15,32)</code> ④ <code>(8,15,6)</code></p>
<span id="question-O31-14" data-question-id="O31-14" class="section-anchor"></span><h4 id="14-attention">14번. Attention</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-10">어텐션의 분모·위치 정보·마스크는 역할이 다르다</a></p></details>
<p>스케일 조정 내적 어텐션(scaled dot-product attention)에서 <code>sqrt(d_k)</code>로 나누는 주된 이유는?</p>
<p>① 시퀀스 길이를 줄이기 위해<br>② 차원 수와 함께 점수 크기가 커져 소프트맥스가 포화하는 현상을 완화하기 위해<br>③ 값(value)을 원-핫 벡터로 만들기 위해<br>④ 위치 인코딩을 제거하기 위해</p>
<span id="question-O31-15" data-question-id="O31-15" class="section-anchor"></span><h4 id="15-transformer">15번. Transformer</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-10">어텐션의 분모·위치 정보·마스크는 역할이 다르다</a></p></details>
<p>기본 자기어텐션(self-attention)에 위치 정보가 필요한 이유는?</p>
<p>① 어텐션은 채널을 처리할 수 없어서<br>② 어텐션만으로는 입력 순서를 명시적으로 알 수 없어서<br>③ 소프트맥스 출력의 합이 1이 아니어서<br>④ 기울기를 계산할 수 없어서</p>
<span id="question-O31-16" data-question-id="O31-16" class="section-anchor"></span><h4 id="16-resnet">16번. ResNet</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p>잔차를 더하기 전에 주 분기(main branch)와 지름길 연결(shortcut)의 배열 크기가 다를 때 일반적인 해결 방법은?</p>
<p>① 정답을 원-핫 변환 ② 1×1 투영(projection)과 필요한 보폭 사용 ③ 시그모이드 추가 ④ 손실을 MAE로 변경</p>
<span id="question-O31-17" data-question-id="O31-17" class="section-anchor"></span><h4 id="17_1">17번. 전이학습</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-7">학습·평가 모드의 차이와 데이터 증강·전이학습</a></p></details>
<p>새 이미지 데이터가 적을 때 사전학습 모델을 사용하는 일반적인 첫 단계는?</p>
<p>① 모든 가중치를 무작위로 초기화한다.<br>② 분류 출력층을 교체하고 특징 추출부(backbone)의 가중치를 고정한 뒤 출력층부터 학습한다.<br>③ 검증자료도 반드시 무작위로 잘라 사용한다.<br>④ 정답 라벨을 입력에 추가한다.</p>
...
<p>정상 데이터로 학습한 AE의 일반적인 이상 판정 기준은?</p>
<p>① 복원 오차가 작을수록 이상에 가깝다.<br>② 복원 오차가 검증자료에서 정한 임계값보다 크면 이상으로 판정한다.<br>③ 잠재 차원이 크면 모두 이상으로 판정한다.<br>④ 훈련과 테스트 오차의 평균이 같으면 이상으로 판정한다.</p>
...
<p>VAE의 KL 항이 하는 역할로 가장 적절한 것은?</p>
<p>① 출력을 확정 라벨로 변환한다.<br>② 근사 사후분포를 사전분포에 가깝게 규제한다.<br>③ 이미지 크기를 반으로 줄인다.<br>④ 판별기를 학습한다.</p>
...
</tbody></table></div><div class="table-scroll" role="region" tabindex="0" aria-label="31강 표 2, 좌우로 스크롤할 수 있습니다"><table data-table="2">
<thead>
<tr>
<th>문항</th>
...
<span id="question-O31-22" data-question-id="O31-22" class="section-anchor"></span><h4 id="2-2">2회-2번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>검증 폴드의 중앙값이 결측 대체에 쓰이지 않도록 하는 가장 안전한 구조는? ① 전체 학습 후 분할 ② 각 폴드 안에서 학습하는 Pipeline ③ 테스트 평균 사용 ④ 결측 행을 모두 무조건 삭제</p>
...
<p>일반적인 결정트리에 특성 표준화가 필수가 아닌 이유는? ① 기울기를 쓰지 않기 때문이 아니라, 값의 순서를 기준으로 나누므로 단조 스케일 변환의 영향을 거의 받지 않기 때문 ② 결측이 자동으로 제거되기 때문 ③ 모든 트리가 선형이기 때문 ④ 정답을 사용하지 않기 때문</p>
...
<p>Ridge의 L2 규제 강도 λ를 매우 크게 하면 일반적으로 어떻게 되는가? 여기서 bias는 절편 매개변수가 아니라 추정 편향을 뜻한다. ① 가중치 크기 감소·편향 증가 ② 가중치 폭발 ③ L1 희소성만 발생 ④ 테스트 라벨 사용</p>
...
<p>이진 로지스틱 회귀의 로짓이 <code>ln(3)</code>이면 오즈(odds)와 확률은? ① odds 3, p=0.75 ② odds 0.75, p=3 ③ odds 1, p=.5 ④ odds 3, p=.25</p>
...
<p>KNN의 k를 1에서 매우 크게 늘릴 때 일반적인 변화는? ① 분산 증가·편향 감소 ② 분산 감소·편향 증가 ③ 둘 다 반드시 0 ④ 스케일의 영향 소멸</p>
...
<p>RBF SVM에서 C와 gamma가 모두 지나치게 크면? ① 매우 단순한 경계만 가능 ② 복잡하고 국소적인 경계로 과적합 위험 ③ 선형회귀가 됨 ④ PCA가 자동 실행</p>
...
<p>클래스 비율이 0.8/0.2인 노드의 지니 불순도(Gini)는? ① .16 ② .32 ③ .50 ④ .64</p>
...
<p>랜덤 포리스트(Random Forest)의 핵심은? ① 부스팅만 사용 ② 부트스트랩 표본과 특성의 무작위 선택으로 상관이 낮은 트리들을 만들어 평균 ③ 매우 깊은 트리 하나 ④ 거리 기반 투표</p>
...
<p>그래디언트 부스팅(gradient boosting)의 설명으로 옳은 것은? ① 모든 트리를 독립적으로 병렬 학습만 함 ② 앞 모델의 잔차 또는 손실의 음의 기울기를 순차적으로 보완 ③ 라벨 없이 군집 중심 갱신 ④ 마진만 최대화</p>
...
<p>L1 규제로 계수가 0이 된 특성을 제거하는 방식은? ① 래퍼 방식만 해당 ② 내장형 특성 선택(embedded selection) ③ PCA 특성 추출 ④ 군집화</p>
...
<p>PCA에 대한 옳은 설명은? ① 정답 클래스 간 분리만 최대화 ② X의 분산이 큰 직교 방향을 찾는 비지도 특성 추출 ③ 원래 특성 일부만 선택 ④ 스케일과 무관</p>
...
<p>입력 특성이 8개이고 클래스가 5개인 LDA의 판별축은 최대 몇 개인가? ① 2 ② 4 ③ 5 ④ 특성 수와 무관하게 10</p>
...
<p>K-means는 군집 중심을 어떤 값으로 갱신하는가? ① 군집 안 점들의 평균 ② 가장 먼 점 ③ 정답의 평균 ④ 서포트 벡터</p>
...
<p>DBSCAN의 장점은? ① 군집 수 k가 반드시 필요함 ② 임의 모양의 군집과 잡음을 식별할 수 있음 ③ 고차원에서 항상 완벽함 ④ 스케일과 전혀 무관함</p>
<span id="question-O31-36" data-question-id="O31-36" class="section-anchor"></span><h4 id="2-16">2회-16번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>불균형 단일라벨 분류에서 폴드별 클래스 비율을 유지하려면? ① KFold ② StratifiedKFold ③ GroupKFold만 ④ PCA</p>
<span id="question-O31-37" data-question-id="O31-37" class="section-anchor"></span><h4 id="2-17">2회-17번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>타깃 인코딩(target encoding)의 가장 큰 위험은? ① 특성 수 감소 ② 자기 행 또는 검증 정답의 통계가 포함되는 누수 ③ 숫자로 변환됨 ④ 범주가 존재함</p>
...
<p>큰 오차에 제곱 벌점을 주면서 정답의 원래 단위로 해석할 수 있는 지표는? ① RMSE ② MAE ③ 정확도 ④ 엔트로피</p>
<span id="question-O31-39" data-question-id="O31-39" class="section-anchor"></span><h4 id="2-19">2회-19번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>탐색 차원이 많고 평가 횟수가 제한될 때 그리드 탐색보다 효율적인 경우가 많은 방법은? ① RandomizedSearch ② 테스트 점수로 수동 선택 ③ 모든 조합 무한 반복 ④ 검증자료 삭제</p>
<span id="question-O31-40" data-question-id="O31-40" class="section-anchor"></span><h4 id="2-20">2회-20번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-2">학습 종류·분할·누수·탐색에서 사용할 자료 구분하기</a></p></details>
<p>SMOTE의 올바른 적용 위치는? ① 분할 전 전체 데이터 ② 각 훈련 폴드 내부 ③ 검증·테스트 자료 ④ 제출 후</p>
...
<span id="question-O31-43" data-question-id="O31-43" class="section-anchor"></span><h4 id="3-3">3회-3번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p><code>Linear(12,5)</code>의 매개변수 수와 배치 크기 7일 때의 출력 크기는? ① 60개, <code>(7,5)</code> ② 65개, <code>(7,5)</code> ③ 65개, <code>(5,7)</code> ④ 17개, <code>(7,12)</code></p>
<span id="question-O31-44" data-question-id="O31-44" class="section-anchor"></span><h4 id="3-4">3회-4번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details>
...
<p>TP=40, FP=10, FN=40일 때 정밀도·재현율·F1은? ① .8/.5 약 .615 ② .5/.8 약 .615 ③ .8/.8 .8 ④ .4/.5 .444</p>
...
<p>이 모의에서는 RMSLE의 정답과 예측이 모두 0 이상이어야 한다고 정의한다. 이 입력 규칙에 맞지 않는 값은? ① 0 ② 양수 ③ 음수 ④ 1</p>
<span id="question-O31-48" data-question-id="O31-48" class="section-anchor"></span><h4 id="3-8">3회-8번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-7">학습·평가 모드의 차이와 데이터 증강·전이학습</a></p></details>
<p>이미지 분류의 데이터 증강 적용으로 가장 올바른 것은? ① 훈련·검증·테스트 모두 무작위 자르기·뒤집기 적용 ② 훈련에만 라벨을 보존하는 무작위 변환을 적용하고 검증·테스트에는 고정된 크기 조절·정규화 적용 ③ 검증에만 강한 무작위 변환 적용 ④ 테스트 라벨을 보고 변환 선택</p>
<span id="question-O31-49" data-question-id="O31-49" class="section-anchor"></span><h4 id="3-9">3회-9번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p><code>MaxPool2d(2,2)</code>가 <code>(B,16,32,40)</code>에 적용된 출력 크기는? ① <code>(B,16,16,20)</code> ② <code>(B,8,16,20)</code> ③ <code>(B,16,32,40)</code> ④ <code>(B,32,16,20)</code></p>
<span id="question-O31-50" data-question-id="O31-50" class="section-anchor"></span><h4 id="3-10">3회-10번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-7">학습·평가 모드의 차이와 데이터 증강·전이학습</a></p></details>
<p><code>BatchNorm1d(20)</code>의 학습 매개변수 γ,β의 수는? ① 20 ② 40 ③ 60 ④ 배치 크기에 따라 변함</p>
<span id="question-O31-51" data-question-id="O31-51" class="section-anchor"></span><h4 id="3-11">3회-11번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-9">RNN의 상태와 입력 구간의 시점을 분리하기</a></p></details>
<p>LSTM 셀 상태 갱신식로 옳은 것은? ① <code>c_t=f_t⊙c_{t-1}+i_t⊙g_t</code> ② <code>c_t=softmax(x)</code> ③ <code>c_t=QKᵀ</code> ④ <code>c_t=maxpool(x)</code></p>
<span id="question-O31-52" data-question-id="O31-52" class="section-anchor"></span><h4 id="3-12">3회-12번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-9">RNN의 상태와 입력 구간의 시점을 분리하기</a></p></details>
<p>길이 T=500인 유효 시계열에서 입력은 X[e-19:e+1], 단일 정답은 y[e+30]이다. 그룹을 넘나들지 않으며 결측이 없고 stride=1일 때 만들 수 있는 윈도 수는? ① 450 ② 451 ③ 470 ④ 500</p>
<span id="question-O31-53" data-question-id="O31-53" class="section-anchor"></span><h4 id="3-13">3회-13번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-9">RNN의 상태와 입력 구간의 시점을 분리하기</a></p></details>
<p>정답 인덱스가 cut 이상이면 검증자료에 배정하는 규칙이 있다. cut=400이고 윈도의 정답 인덱스가 400, 마지막 입력 인덱스가 370일 때 이 윈도는 어디에 배정되는가? ① 훈련 ② 검증 ③ 폐기만 가능 ④ 무작위</p>
<span id="question-O31-54" data-question-id="O31-54" class="section-anchor"></span><h4 id="3-14">3회-14번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-10">어텐션의 분모·위치 정보·마스크는 역할이 다르다</a></p></details>
<p>한 질의(query)의 점수가 <code>[0, ln3]</code>이면 소프트맥스 가중치는? ① <code>[.5,.5]</code> ② <code>[.25,.75]</code> ③ <code>[.75,.25]</code> ④ <code>[0,1]</code></p>
...
<p>VAE에서 <code>mu=0, logvar=0</code>인 1차원 사후분포와 N(0,1) 사전분포의 KL은? ① 0 ② .5 ③ 1 ④ 무한대</p>
...
<p>AE의 정상 검증 오차에서 99번째 백분위수를 임계값으로 썼다. 점수가 임계값보다 큰 샘플의 일반적인 라벨은? ① 정상 ② 이상 ③ 클래스 99 ④ 알 수 없어 항상 삭제</p>
...
<p>GAN의 판별기 학습 단계에서 <code>G(z).detach()</code>의 목적은? ① G로 이어지는 기울기 계산 그래프 차단 ② D의 기울기 차단 ③ 시그모이드 두 번 적용 ④ 잡음 제거</p>
<span id="question-O31-58" data-question-id="O31-58" class="section-anchor"></span><h4 id="3-18">3회-18번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-8">CNN·풀링·Linear·잔차 연결의 크기와 파라미터</a></p></details>
<p>잔차 블록의 주 분기 출력이 <code>(B,64,16,16)</code>, 입력이 <code>(B,32,32,32)</code>일 때 지름길 연결은? ① identity ② 1×1, stride2, 32→64 ③ maxpool만 ④ softmax</p>
<span id="question-O31-59" data-question-id="O31-59" class="section-anchor"></span><h4 id="3-19">3회-19번</h4><details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details>
<p>라벨이 5개인 다중라벨 분류의 올바른 출력·정답·손실 조합은? ① 로짓 <code>(B,5)</code>, 실수형 정답 <code>(B,5)</code>, BCEWithLogits ② 로짓 <code>(B,5)</code>, long 정수형 정답 <code>(B,)</code>, CE ③ 로짓 <code>(B,1)</code>, 정답 <code>(B,5)</code> ④ argmax만 사용</p>
...
<p>문제가 정확히 <code>(8333,3)</code> NPY를 요구할 때 <code>(8333,)</code>이 나온 모델의 올바른 대응은? ① 파일명만 변경 ② 출력 3개를 내도록 모델과 예측 코드 수정 ③ 같은 배열 세 번 저장하지 않고 무조건 제출 ④ flatten</p>
...
3e:Tf67,<h3 id="visual-31-7">스스로 확인하기</h3><ol>
<li id="question-V31-01" data-question-id="V31-01">세 클래스의 로짓이 모두 같으면 정답 클래스의 확률과 CE는 무엇인가?<details class="question-prerequisites"><summary>풀이에 필요한 이론</summary><p><a href="#theory-31-6">텐서·손실·미분·최적화를 연결해 이해하기</a></p></details></li>
...
<li><p>먼저 볼 조건: 세 로짓이 모두 같고 단일정답·가중치 없는 CE다.</p>
<p>단계 풀이: 공통값을 c라고 하면 각 확률 exp(c)/(3exp(c))=1/3. 손실은 −log(1/3)=log3다.</p>
<p>정답: 확률 1/3, CE <code>-log(1/3)=log3≈1.099</code>다. 모두 같은 로짓이면 공통 크기가 무엇이든 소프트맥스에서 상쇄된다. 로짓이 0이므로 손실도 0이라는 해석은 틀리다.</p>
<p>왜: 소프트맥스는 절대 점수보다 클래스 사이 비율을 사용한다.</p>
<p>헷갈리기 쉬운 부분: 로짓 0을 확률 0 또는 손실 0으로 읽지 않는다.</p>
<p>한 줄 기억: 같은 K개 로짓의 정답 확률은 1/K다.</p>
</li>
<li><p>먼저 볼 조건: 정밀도는 예측 양성, 재현율은 실제 양성을 분모로 삼는다.</p>
<p>단계 풀이: P=3/(3+1)=0.75. R=3/(3+3)=0.5. F1=2×3/(6+1+3)=0.6.</p>
<p>정답: 정밀도 <code>3/4=0.75</code>, 재현율 <code>3/6=0.5</code>, F1 <code>6/(6+1+3)=0.6</code>이다. 정밀도와 재현율의 단순 산술평균 0.625가 F1이 아니다.</p>
<p>왜: 두 비율을 함께 보는 F1은 조화평균이다.</p>
<p>헷갈리기 쉬운 부분: (0.75+0.5)/2=0.625는 산술평균이지 F1이 아니다.</p>
<p>한 줄 기억: 분모 집단을 적고 F1은 별도 식으로 검산한다.</p>
</li>
<li><p>먼저 볼 조건: 첫 순회 예산 35분에서 이미 쓴 시간을 빼야 한다.</p>
<p>단계 풀이: 5×4=20분 사용 → 35−20=15분 남음 → 15문항으로 나누면 문항당 1분.</p>
<p>정답: 평균 1분이다. 일부 긴 문항이 처음 한 바퀴 푸는 데 배정한 시간을 너무 많이 쓰면 나머지 쉬운 문제도 급하게 풀게 된다. 풀 수 없는 문제를 표시하고 돌아오는 연습을 하되, 보류 기준은 자기 기록으로 조절한다.</p>
<p>왜: 전체 50분에는 보류 문제와 답안 점검 시간도 포함돼 있다.</p>
<p>헷갈리기 쉬운 부분: 전체 평균 2.5분을 첫 순회의 모든 문항에 고정 배정하지 않는다.</p>
<p>한 줄 기억: 보류 기준은 남은 시간과 남은 문항으로 조정한다.</p>
</li>
</ol></div></details><h3 id="visual-31-9">더 읽을 공식 자료</h3><p>손실함수의 입력 조건은 <a href="https://docs.pytorch.org/docs/2.7/generated/torch.nn.CrossEntropyLoss.html" target="_blank" rel="noreferrer noopener">PyTorch CrossEntropyLoss</a>, 지표 정의는 <a href="https://scikit-learn.org/stable/modules/model_evaluation.html" target="_blank" rel="noreferrer noopener">scikit-learn model evaluation</a>에서 풀이 후 확인한다. 이 모의의 점수·시간 운영은 자가 학습을 위한 설정이며 공식 합격선이 아니다.</p>39:["$","section",null,{"className":"visual-assessment","aria-label":"기초 확인문제와 해설","children":["$","div",null,{"dangerouslySetInnerHTML":{"__html":"$3e"}}]}]
