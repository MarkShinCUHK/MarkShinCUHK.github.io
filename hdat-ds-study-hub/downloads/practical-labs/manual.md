...
공식 안내상 실기는 오픈북이지만 생성형 AI 활용은 금지입니다. 이 사이트와 다운로드 파일은 **시험 전 학습용**이며 외부 사이트·파일·import 허용 여부는 회차 규정이 우선합니다. GitBook 상세 환경은 이번 확인에서 접근되지 않았습니다. [회차 안내](https://hdat.gitbook.io/2026-hdat-ds)
