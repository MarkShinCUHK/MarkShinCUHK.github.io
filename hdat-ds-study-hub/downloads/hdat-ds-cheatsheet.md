...
**`hdat_templates`의 괄호 안에 넣을 값이 막히면 [실제 호출 매뉴얼](./templates/)을 보세요.** 작은 표에서 입력·정답을 만들고, loader·모델·학습·예측·저장을 연결합니다. 공개 함수와 모델 44개의 필수 인자, 기본값, 값의 출처도 정리했습니다. [오프라인 매뉴얼](./downloads/hdat-template-guide.html)도 함께 저장할 수 있습니다.
